...
public class ExtentCucumberFormatter implements Reporter, Formatter {
    ...
    private static void setExtentHtmlReport(File file) {
        ...
        if (file == null || file.getPath().isEmpty()) {
            System.out.println("file report name in Extent Cucumber Formatter before :  "+file);
            file = new File(ExtentProperties.INSTANCE.getReportPath());
            System.out.println("file report name in Extent Cucumber Formatter after :  "+file);
       ...
       /* String string=System.getProperty("TestType").replace("@","").trim();
        ...
        System.out.println("file report name in Extent Cucumber Formatter after :  "+replacePathSymbol(file.getPath(),string));*/
        //file=new File(replacePathSymbol(file.getPath(),string));
    ...
    private static String replacePathSymbol(String str,String append) {
        System.out.println("str before : "+str);
        String str1 = str.replace("/", "-");
        String[] a = str1.split("-");
        int length = a.length;
        System.out.println("str : "+a[length - 1]);
        str=str.replace(a[length - 1],append+"_"+a[length - 1]);
        System.out.println("str : "+str);
        // String str1 = append+"_"+a[length - 1];
        return str;
    }
